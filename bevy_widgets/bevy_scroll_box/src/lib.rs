...
fn spawn_scroll_bar<'a>(
    ...
    let scrollbar = commands
        ...
        .insert(theme.scroll_box.background_color)
        .id();
    ...
    commands
        .spawn(match direction {
            ScrollBarHandleDirection::Vertical => Node {
                ...
                border_radius: theme.scroll_box.border_radius,
                ..default()
            },
            ScrollBarHandleDirection::Horizontal => Node {
        ...
        .insert(ScrollBarHandle(direction))
        .insert(BackgroundColor(theme.scroll_box.handle_color))
        .insert(ChildOf(scrollbar))
        .observe(
